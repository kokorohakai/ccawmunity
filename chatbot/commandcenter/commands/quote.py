...
class QuoteCommand(Command):
    def __init__(self):
        ...
        self.help += "2. user. Prints a random quote by the supplied user.\n"
        self.help += "3. remove, id. Removes a quote by id."
        self.help += "4. add, user, quote. Adds a quote for user.\n"
        self.author = "skuld"
